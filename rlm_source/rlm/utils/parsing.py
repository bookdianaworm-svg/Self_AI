...
def format_iteration(
    ...
    for code_block in iteration.code_blocks:
        ...
        formatted_result = format_execution_result(code_block.result)
        if len(formatted_result) > max_character_length:
            formatted_result = (
                formatted_result[:max_character_length]
                + f"... + [{len(formatted_result) - max_character_length} chars...]"
            )
